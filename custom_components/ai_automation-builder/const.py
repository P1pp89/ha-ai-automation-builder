...
WS_TYPE_PREVIEW_AUTOMATION = "ai_automation_builder/preview_automation"
WS_TYPE_TEST_AUTOMATION = "ai_automation_builder/test_automation"
WS_TYPE_DRY_RUN_AUTOMATION = "ai_automation_builder/dry_run_automation"
